...
/**
 * Helper class to store {@link Subscription}s and {@link Video}s in {@link SharedPreferences}.
 *
...
//    }
     ...
     * @return a list of movies or an empty list if none exist.
     */
    public static List<Video> readVideos(Context context, long channelId) {
        return getList(context, Video.class, PREFS_SUBSCRIBED_MOVIES_PREFIX + channelId);
    }
...
//    }
     ...
     * @param movies to be stored.
     */
    public static void storeVideos(Context context, long channelId, List<Video> movies) {
        setList(context, movies, PREFS_SUBSCRIBED_MOVIES_PREFIX + channelId);
    }
